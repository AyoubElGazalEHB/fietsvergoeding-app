...
-- Seed data for rides
INSERT INTO rides (employee_id, trajectory_id, ride_date, direction, portion, km_total, amount_euro, created_at) VALUES
(1, 1, CURRENT_DATE - INTERVAL '5 days', 'heen', 'volledig', 10.0, 2.70, CURRENT_TIMESTAMP),
(1, 2, CURRENT_DATE - INTERVAL '5 days', 'terug', 'gedeeltelijk', 7.5, 2.03, CURRENT_TIMESTAMP),
(2, 3, CURRENT_DATE - INTERVAL '3 days', 'heen_terug', 'volledig', 10.0, 2.70, CURRENT_TIMESTAMP),
(3, 4, CURRENT_DATE - INTERVAL '2 days', 'heen', 'gedeeltelijk', 10.0, 2.30, CURRENT_TIMESTAMP),
(4, 5, CURRENT_DATE - INTERVAL '1 day', 'terug', 'volledig', 12.0, 2.76, CURRENT_TIMESTAMP),
(5, 6, CURRENT_DATE - INTERVAL '1 day', 'heen_terug', 'gedeeltelijk', 25.0, 6.75, CURRENT_TIMESTAMP);